...
export default function RegistroDescarte() {
  ...
  const confirmarDescarte = async () => {
    try {
      await axios.post("http://localhost:8000/api/descarte", {
        vendedor_id: 1, // trocar pelo ID real
        ponto_id: pontoSelecionado.id,
        quantidade_kg: 10,
        foto_url: "https://via.placeholder.com/100", // ou base64
      });
